...
class DatabaseSeederTest extends TestCase
{
    ...
    public function test_database_seeder_creates_default_working_hours_for_new_seeded_doctor(): void
    {
        ...
        $patient = User::where('email', 'patient@example.com')->firstOrFail();

        $this->assertTrue($doctor->user->hasRole(User::ROLE_DOCTOR));
        $this->assertTrue($patient->hasRole(User::ROLE_PATIENT));
