  ...
  <section class="portal-section operations-dashboard">
    <div class="portal-page-heading portal-heading-row">
      <div>
        ...
        <p>
          {{ $mode === 'schedule'
            ? 'Visualizza la giornata in ordine cronologico e gestisci gli slot liberi.'
            : 'Segui il flusso delle visite di oggi in ordine cronologico.' }}
        </p>
      </div>
      @if ($mode === 'schedule')
    ...
    <section class="portal-panel doctor-agenda-panel">
      <div class="section-heading">
        <div>
          <h2>{{ $mode === 'schedule' ? 'Agenda del giorno' : 'Agenda di oggi' }}</h2>
    ...
    @if ($mode === 'schedule')
      <details class="availability-manager" @if ($availabilityPreview) open @endif>
        <summary class="availability-manager__summary">
